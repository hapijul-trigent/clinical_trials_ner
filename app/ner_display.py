    ...
    def __display_ner(self, result, label_col, document_col, original_text, labels_list = None):
        ...
        for entity in sorted_labs:
            ...
            if entity_type in label_color:
                html_output += '<span class="spark-nlp-display-entity-wrapper" style="background-color: {}"><button class="spark-nlp-display-entity-name">{} </button><span class="spark-nlp-display-entity-type">{}</span></span>'.format(
